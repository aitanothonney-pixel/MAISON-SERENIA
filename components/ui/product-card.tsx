    ...
    <div className={cn('my-4 flex gap-3 px-4', className)}>
      {productColors.map((productColor, index) => (
        <button
          ...
          className="relative size-5 appearance-none rounded-full border-2 border-neutral-200 transition-all hover:border-neutral-400"
        ...
        >
          {index === activeColor && (
            <motion.div
              layoutId={productId}
              className="absolute -left-1 -top-1 size-[22px] rounded-full border-2 border-black"
