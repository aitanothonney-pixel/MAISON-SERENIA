      ...
      <Link href={`/products/${product.id}`}>
        <div className={`relative overflow-hidden aspect-[4/3] bg-white ${product.name.includes('Bubble') || product.category === 'Figurines' ? 'p-3' : ''}`}>
          <Image
            ...
            className={`w-full h-full transition-all duration-700 group-hover:scale-105 ${isBubble && product.images[1] ? 'group-hover:opacity-0' : ''} ${product.name.includes('Bubble') || product.category === 'Figurines' ? 'object-contain' : 'object-cover'} ${product.id === 12 ? 'scale-125' : ''}`}
          />
...
const parallaxImages = [
  { src: 'https://i.ibb.co/Y7bdp0Z7/IMG-0589.jpg', alt: 'Dame canapé blanc', position: 'center 30%' },
  { src: 'https://i.ibb.co/QjXv6K98/IMG-0930.jpg', alt: 'Canapé rouge', position: 'center 60%' },
  { src: 'https://i.ibb.co/99H4L0sP/IMG-2616.jpg', alt: 'Détail design', position: 'center 50%' },
  { src: 'https://i.ibb.co/RkJCsW7S/IMG-0935.jpg', alt: 'Canapé jaune', position: 'center 65%' },
