      ...
      <Link href={`/products/${product.id}`}>
        <div className={`relative overflow-hidden bg-white aspect-[4/3] ${product.name.includes('Bubble') || product.category === 'Figurines' ? 'p-4' : ''}`}>
          <Image
            ...
            width={600}
            height={450}
            style={isBubble ? { transform: product.id === 12 ? 'scale(1.35)' : 'scale(1.15)', transformOrigin: 'center center' } : product.id === 34 ? { transform: 'scale(1.35)', transformOrigin: 'center center' } : undefined}
          ...
          {isBubble && product.images[1] && (
            <Image
              ...
              width={600}
              height={450}
              style={{ transform: product.id === 12 ? 'scale(1.35)' : 'scale(1.15)', transformOrigin: 'center center' }}
