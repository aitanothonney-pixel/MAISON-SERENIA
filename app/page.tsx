      ...
      <section className="py-24 bg-white border-t border-neutral-100">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-12">
            <p className="text-[10px] tracking-[0.5em] uppercase text-neutral-400 mb-4">Personnalisation</p>
            ...
            <p className="text-sm text-neutral-400 tracking-[0.2em] uppercase">Survolez pour changer de vue · Choisissez votre couleur</p>
          </div>
          <ColorSelectorCard
            ...
            colors={['#f0ede8', '#1a2fad', '#c0392b', '#6b3fa0']}
            className="max-w-2xl mx-auto"
          />
          <div className="text-center mt-8">
            <Link
              href="/products/10"
              className="inline-block text-xs tracking-[0.35em] uppercase border border-black px-10 py-3.5 hover:bg-black hover:text-white transition-all duration-300"
            >
              Découvrir le Canapé Bubble
            </Link>
          </div>
        </div>
      </section>
